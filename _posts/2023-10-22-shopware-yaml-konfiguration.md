---
title: Shopware.yaml Konfigurationsmöglichkeiten
layout: post
date: '2023-10-22 20:37:56 +0100'
cover: assets/images/shopware-yaml.png
categories:
- entwickler
- shopbetreiber
---

Die `shopware.yaml` findest du unter `<shopRoot>/config/packages`.
